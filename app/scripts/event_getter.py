...
for building in reversed(buildings):
	...
	for room in reversed(building[1:]):
		...
		time.sleep(1)
		classes = driver.find_element_by_id('FullClassScheduleTable').get_attribute('innerHTML')
		events = driver.find_element_by_id('FullEventScheduleTable').get_attribute('innerHTML')
